...
def check_tts_status(api_key, request_id, input_text_length):
    ...
    initial_wait_time = input_text_length * 0.05
    print(
...
def main():
    ...
    speed_rate = 1.0
    output_file_name = "audio_output3"
    local_audio_path = f"D:/RMIT Studies/Capstone Project/VBee/{output_file_name}.wav"
    ...
    if "result" in response_data and "request_id" in response_data["result"]:
        ...
        print(
            "Request ID not found in the POST response. Here's the POST response:",
            response_data,
        )
